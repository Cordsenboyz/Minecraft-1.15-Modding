...
public class CordsenIceSpikeFeature extends IceSpikeFeature {
    public CordsenIceSpikeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51493_1_) {
        super(p_i51493_1_);
    }
    @Override
                ...
                for (int i1 = -l; i1 <= l; ++i1) {
                    ...
                    for (int j1 = -l; j1 <= l; ++j1) {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(rand.nextFloat() > 0.75F))) {
                            ...
                            if (blockstate.isAir(worldIn, pos.add(i1, k, j1)) || isDirt(block) ||  block == Blocks.ICE) {
            ...
            for (int l1 = -k1; l1 <= k1; ++l1) {
                for (int i2 = -k1; i2 <= k1; ++i2) {
                    ...
                    while (blockpos.getY() > 50) {
                        ...
                        if (!blockstate1.isAir(worldIn, blockpos) && !isDirt(block1)  && block1 != Blocks.ICE && block1 != Blocks.PACKED_ICE) {
                            break;
                        }
