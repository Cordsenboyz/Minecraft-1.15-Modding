...
public class ModCaveCarver extends CaveWorldCarver {
    public ModCaveCarver(Function<Dynamic<?>, ? extends ProbabilityConfig> p_i49929_1_) {
        ...
        this.carvableBlocks = ImmutableSet.of(Blocks.DIRT, Blocks.STONE, BlockInit.RED_GRASS.get(), Blocks.PACKED_ICE, Blocks.ICE, BlockInit.BLACKSTONE.get(), BlockInit.BASALT.get());
