...
public class RuinedTower extends Structure<NoFeatureConfig> {
    public RuinedTower(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
        super(config);
    }
    ...
    public IStartFactory getStartFactory() {
        return RuinedTower.Start::new;
    }

    @Override
    public String getStructureName() {
        return CordsenMod.MOD_ID + "ruinedtower";
    }
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            ...
            RuinedTowerPieces.start(templateManagerIn, pos, rotation, this.components, this.rand);

            this.recalculateStructureSize();

            CordsenMod.LOGGER.info("We can find a ruinedtower at: " + pos);
