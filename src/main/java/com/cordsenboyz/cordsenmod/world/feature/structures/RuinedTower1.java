...
public class RuinedTower1 extends Structure<NoFeatureConfig> {
    public RuinedTower1(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
        super(config);
    }
    ...
    public IStartFactory getStartFactory() {
        return RuinedTower1.Start::new;
    }

    @Override
    public String getStructureName() {
        return CordsenMod.MOD_ID + "ruinedtower1";
    }
    ...
    public static class Start extends StructureStart {
        ...
        public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
            ...
            RuinedTower1Pieces.start(templateManagerIn, pos, rotation, this.components, this.rand);

            this.recalculateStructureSize();

            CordsenMod.LOGGER.info("We can find a ruinedtower1 at: " + pos);
