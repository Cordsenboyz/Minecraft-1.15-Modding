...
public class TempestPickaxeItem extends PickaxeItem {
    public TempestPickaxeItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builder) {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(new TranslationTextComponent("Gives Haste While High Up In The Sky").applyTextStyle(TextFormatting.WHITE));
        }else{
