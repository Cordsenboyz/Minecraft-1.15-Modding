...
public class TempestHelmetItem extends ArmorItem {
    public TempestHelmetItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add(new TranslationTextComponent("Gives Nightvision While High Up In The Sky").applyTextStyle(TextFormatting.WHITE));
        }else{
