...
import com.cordsenboyz.cordsenmod.util.FunctionalIntReferenceHolder;
...
public class AlloyFurnaceContainer extends Container {
    ...
    // Server Constructor
    public AlloyFurnaceContainer(final int windowID, final PlayerInventory playerInv,
                                   final AlloyFurnaceTileEntity tile) {
        super(ModContainerTypes.ALLOY_FURNACE.get(), windowID);
