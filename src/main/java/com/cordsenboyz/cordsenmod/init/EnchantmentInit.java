...
public class EnchantmentInit {
    ...
    public static final RegistryObject<Enchantment> ADVANCED_FEATHERFALLING = ENCHANTMENTS.register("advanced_featherfalling", () -> new AdvancedProtectionEnchantment(Enchantment.Rarity.VERY_RARE, AdvancedProtectionEnchantment.Type.FALL, EquipmentSlotType.FEET));
