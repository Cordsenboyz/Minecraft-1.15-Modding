...
import com.cordsenboyz.cordsenmod.objects.blocks.IronBarrelBlock;
...
public class IronBarrelTileEntity extends LockableLootTileEntity {
    ...
    public IronBarrelTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }
    public IronBarrelTileEntity() {
        this(ModTileEntityTypes.IRON_BARREL.get());
    }
    ...
    protected Container createMenu(int id, PlayerInventory player) {
        return new IronBarrelContainer(id, player, this);
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.iron_barrel");
    }
    ...
    protected void onOpenOrClose() {
        ...
        if(block instanceof IronBarrelBlock){
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
        ...
        if(blockstate.hasTileEntity()) {
            ...
            if(tileEntity instanceof IronBarrelTileEntity){
                return ((IronBarrelTileEntity)tileEntity).numPlayerUsing;
            }
        }
        return 0;
    }
    public static void swapContents(IronBarrelTileEntity te, IronBarrelTileEntity otherTe){
