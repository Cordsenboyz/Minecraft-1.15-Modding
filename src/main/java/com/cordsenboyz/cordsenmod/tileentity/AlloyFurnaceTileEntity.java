...
import com.cordsenboyz.cordsenmod.init.RecipeSerializerInit;
import com.cordsenboyz.cordsenmod.objects.blocks.AlloyFurnaceBlock;
import com.cordsenboyz.cordsenmod.recipes.ExampleRecipe;
import com.cordsenboyz.cordsenmod.util.ExampleItemHandler;
...
public class AlloyFurnaceTileEntity extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
                ...
                if (this.getRecipe(this.inventory.getStackInSlot(0)) != null) {
                    if (this.currentSmeltTime != this.maxSmeltTime) {
                        this.world.setBlockState(this.getPos(),
                                this.getBlockState().with(AlloyFurnaceBlock.LIT, true));
                        this.currentSmeltTime++;
                        dirty = true;
                    } else {
                        this.world.setBlockState(this.getPos(),
                                this.getBlockState().with(AlloyFurnaceBlock.LIT, false));
    ...
    private ITextComponent getDefaultName() {
        return new TranslationTextComponent("container." + CordsenMod.MOD_ID + ".alloy_furnace");
    }
