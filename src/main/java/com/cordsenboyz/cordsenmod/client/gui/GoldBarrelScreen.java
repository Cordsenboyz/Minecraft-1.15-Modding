...
@OnlyIn(Dist.CLIENT)
public class GoldBarrelScreen extends ContainerScreen<GoldBarrelContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(CordsenMod.MOD_ID, "textures/gui/gold_barrel.png");

    public GoldBarrelScreen(GoldBarrelContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
